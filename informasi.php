...
<header id="header" class="fixed-top">
  <div class="container d-flex align-items-center">
    ...
    <h1 class="logo mr-auto"><a href="index.php">Portal Universitas Budiyana Bengkulu</a></h1>
...
<section id="team" class="team section-bg">
  ...
  <div class="container">
   ...
   <div class="section-title">
    ...
    <p>Universitas Budiayana Bengkulu</p>
  </div>
     ...
     <center>
      <div class="col-lg-5 col-md-6 d-flex align-items-stretch">
        <div class="member">
          <h2><?=$row['judul'];?></h2>
          <br><br>
          <img src="admin/gambar/informasi/<?php echo $row['gambar_informasi']; ?>" style="height: 40%; ">
          
          <span></i>Deskripsi : <?=$row['deskripsi']; ?></span>
          <p>
           <?=$row['deskripsi']; ?>
         </p>
...
<footer id="footer">
  <div class="container">
    ...
    <div class="copyright">
      &copy; Copyright <strong><span>Universitas Budiayan Bengkulu</span></strong>. All Rights Reserved
    </div>
